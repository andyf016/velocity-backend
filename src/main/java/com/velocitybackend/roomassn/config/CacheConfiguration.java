package com.velocitybackend.roomassn.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.velocitybackend.roomassn.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.velocitybackend.roomassn.repository.UserRepository.USERS_BY_EMAIL_CACHE);
